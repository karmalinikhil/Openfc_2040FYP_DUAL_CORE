...
[cite_start]*Subject to general operating conditions for Vdd and Top.* [cite: 316, 318]
...
[cite_start]*Note: Values are guaranteed at 10 MHz clock frequency for SPI with both 4 and 3 wires.* [cite: 320]
...
* [cite_start]**MSb first**: Data is transferred with the Most Significant Bit first. [cite: 734, 741]
...
3.  [cite_start]The address is automatically incremented for every subsequent block of 8 clock pulses. [cite: 745]

#### 1.3.4 SPI 3-Wire Mode
[cite_start]A 3-wire mode (using SDI/O as bidirectional) is entered by setting bit **SIM** to `1` in register **CTRL3_C (12h)**. [cite: 809]
...
[cite_start]**STATUS_REG (1Eh)** [cite: 1359-1364]
...
[cite_start]*Values are compliant with the FS and ODR settings in CTRL2_G (11h).* [cite: 1377]

| Address (Hex) | Name | Description | Source Ref |
| :--- | :--- | :--- | :--- |
| **22** | **OUTX_L_G** | [cite_start]Pitch axis (X) angular rate value (LSByte) | [cite: 1374] |
| **23** | **OUTX_H_G** | [cite_start]Pitch axis (X) angular rate value (MSByte) | [cite: 1389] |
| **24** | **OUTY_L_G** | [cite_start]Roll axis (Y) angular rate value (LSByte) | [cite: 1400] |
| **25** | **OUTY_H_G** | [cite_start]Roll axis (Y) angular rate value (MSByte) | [cite: 1419] |
| **26** | **OUTZ_L_G** | [cite_start]Yaw axis (Z) angular rate value (LSByte) | [cite: 1427] |
| **27** | **OUTZ_H_G** | [cite_start]Yaw axis (Z) angular rate value (MSByte) | [cite: 1437] |

### 2.3 Accelerometer Output Registers
[cite_start]*Values are compliant with the FS and ODR settings in CTRL1_XL (10h).* [cite: 1172]

| Address (Hex) | Name | Description | Source Ref |
| :--- | :--- | :--- | :--- |
| **28** | **OUTX_L_XL** | [cite_start]X-axis linear acceleration value (LSByte) | [cite: 1448] |
| **29** | **OUTX_H_XL** | [cite_start]X-axis linear acceleration value (MSByte) | [cite: 1462] |
| **2A** | **OUTY_L_XL** | [cite_start]Y-axis linear acceleration value (LSByte) | [cite: 1469] |
| **2B** | **OUTY_H_XL** | [cite_start]Y-axis linear acceleration value (MSByte) | [cite: 1479] |
| **2C** | **OUTZ_L_XL** | [cite_start]Z-axis linear acceleration value (LSByte) | [cite: 1487] |
| **2D** | **OUTZ_H_XL** | [cite_start]Z-axis linear acceleration value (MSByte) | [cite: 1495] |

### 2.4 Temperature Output Registers
[cite_start]*The value is expressed as two's complement.* [cite: 1372]
